	...
	return useRoutes( [
		...
		},
		{
			...
			children: [
				...
				{ path: appLinks.catalog.promotions, element: <PromotionsPage /> },
		...
		},
		{
			...
			children: [
				...
				{ path: appLinks.setup.shop, element: <StoreSetupPage /> },
		...
		{
			path: appLinks.publicPurchaseOrder( ":orderNumber", ":orderHash" ),
