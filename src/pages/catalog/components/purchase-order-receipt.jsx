...
import logo from '../../../static/svg/icons/lost.svg'
import { useQuery } from 'react-query'
import { Loader } from '@mantine/core'
import { getRestockReceipt } from '../../../helpers/api'
import { cedisLocale } from '../../../helpers/utilities'
import { useRef, useState } from 'react'
import { useReactToPrint } from 'react-to-print'

const PurchaseOrderReceipt = ( { orderNumber } ) => {
    const printArea = useRef();
    const [ grandTotal, setTotal ] = useState( 0 )

    const { data, isFetching } = useQuery( {
        queryFn: () => getRestockReceipt( orderNumber ),
        queryKey: [ 'restock-receipt', orderNumber ],
        onSuccess: data => {
            let sum = 0
