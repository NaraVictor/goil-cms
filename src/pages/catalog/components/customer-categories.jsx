...
import NewCustomerGroupForm from './new-customer-group'
...
const CustomerCategoriesPage = ( props ) => {
    ...
    const handleEdit = ( id ) => {
        setModal( {
            ...
            isOpen: true,
            content: <EditCategoryForm id={ id } onUpdate={ refetch } type="customer" canEdit={ true } />
        } )
    }
    ...
    return (
        <section className="mt-4 pb-4">
            ...
            {/* buttons */ }
            <div className="mt-3">
                <button className="bokx-btn btn-prim" onClick={ () => setModal( {
                    content: <NewCustomerGroupForm onUpdate={ refetch } />,
